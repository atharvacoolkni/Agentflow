...
from agentflow.runtime.adapters.llm.base_converter import BaseConverter, ConverterType
    ...
    async def test_convert_streaming_response_functionality(self):
        ...
        class TestConverter(BaseConverter):
            ...
            async def convert_streaming_response(self, config, node_name, response, meta=None):
                ...
                from agentflow.runtime.publisher.events import Event, EventType, ContentType
                yield EventModel(
