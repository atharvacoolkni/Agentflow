...
class TestLangChainAdapter:
    ...
    @patch('agentflow.runtime.adapters.tools.langchain_adapter.HAS_LANGCHAIN', False)
    ...
    @patch('agentflow.runtime.adapters.tools.langchain_adapter.HAS_LANGCHAIN', True)
